...
public class GroupController {
    ...
    public ResponseData getListName() {
        try {
            List <String> listName = groupService.getListName();
            return new ResponseData(Enums.ResponseStatus.SUCCESS,Constants.CALL_API_SUCCESS,listName );
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseData(String.valueOf(Enums.ResponseStatus.ERROR), e.getMessage());
        }
